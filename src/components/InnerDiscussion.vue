<template>
  <div>
    <div :style="!discussionObj.eType ? 'background-color: #e8f3ff' : 'white'">
      ...
      <inner-comment v-if="discussionObj.eType" :assessmentsNamespace="assessmentsNamespace" :commentsNamespace="commentsNamespace" :commentObj="discussionObj" :class="{ 'mx-10' : depth }"></inner-comment>
      <inner-assessment v-else :namespace="assessmentsNamespace" :assessmentObj="discussionObj" :assessmentType="discussionObj.assessmentType" :class="{ 'mx-10' : depth }"></inner-assessment>
    </div>
